...
request.onsuccess = function(event) {
    // when db is successfully created with its object store (from onupgradeneeded event above) or simply established a connection, save 
    // a reference to db in global variable
...
function saveRecord(record) {
     // open a new transaction, or temporary connection with the database, with read and write permissions 
